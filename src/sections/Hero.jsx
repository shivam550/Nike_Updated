...
import { jootas, statistics } from '../constants'
...
function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen w-full flex xl:flex-row flex-col  gap-10 max-container">
      ...
      bg-center'>
        ...
        {
          jootas.map((joota,index)=>(
            <div key={index}>
               <ShoeCard 
                imgURL={joota}
                changeBigShoeImg={(newjoota)=>{ setBigshoeImage (newjoota)}}
